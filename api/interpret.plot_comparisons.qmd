...
| `average_by`      | Union\[str, list\]                    | The covariates we would like to average by. The passed covariate(s) will marginalize over the other covariates in the model. Defaults to ``None``.                                                                                                                      | `None`     |
