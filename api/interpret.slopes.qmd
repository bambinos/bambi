...
| prob              | float                       | The probability for the credibility intervals. Must be between 0 and 1. Defaults to 0.94. Changing the global variable `az.rcParams["stats.ci_prob"]` affects this default.                                                                                                                                                                                                                                                                                   | `None`     |
...
|--------|--------------|-----------------------------------------------------------------------------------------------------------------------|
|        | pd.DataFrame | A dataframe with the comparison values, highest density interval, `wrt` name, contrast value, and conditional values. |
