...
| data              | pd.DataFrame                 | A pandas dataframe containing the data on which the model will be fit, with column names matching variables defined in the formula.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | _required_   |
...
| dropna            | bool                         | When `True`, rows with any missing values in either the predictors or outcome are automatically dropped from t, optionalhe dataset in a listwise manner.                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `False`      |
...
| data    | pd.DataFrame or None | An optional data frame with values for the predictors and the response on which the model's log-likelihood function is evaluated. If omitted, the original dataset is used. | `None`     |
...
| Name                    | Type                | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Default   |
|-------------------------|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
| draws                   | int                 | The number of samples to draw from the posterior distribution. Defaults to 1000.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `1000`    |
...
| inference_method        | str                 | The method to use for fitting the model. By default, `"pymc"`. This automatically assigns a MCMC method best suited for each kind of variables, like NUTS for continuous variables and Metropolis for non-binary discrete ones. NUTS implementations include `"pymc"`, `"nutpie"`, `"blackjax"`, and `"numpyro"`. Alternatively, `"vi"`, in which case the model will be fitted using variational inference as implemented in PyMC using the `fit` function. Finally, `"laplace"`, in which case a Laplace approximation is used and is not recommended other than for pedagogical use.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `'pymc'`  |
...
| **kwargs                | dict                | For other kwargs see the documentation for `PyMC.sample()`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `{}`      |

#### Returns {.doc-section .doc-section-returns}

| Name   | Type                                  | Description                                                                                                                                                          |
|--------|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|        | `az.InferenceData` or `Approximation` | It returns an `az.InferenceData` if `inference_method` is `"pymc"`, `"nutpie"`, `"blackjax"`, `"numpyro"`, or `"laplace"`, and an `Approximation` object if  `"vi"`. |
...
| var_names           | str or list of str                                   | A list of names of variables for which to compute the prior predictive distribution. Defaults to `None` which means to include both observed and unobserved RVs.                                                                              | `None`    |
...
| bins                | (int, sequence, auto or None)                        | Controls the number of bins, accepts the same keywords `matplotlib.pyplot.hist()` does. Only works if `kind == "hist"`. If `None` (default) it will use `"auto"` for continuous variables and `range(xmin, xmax + 1)` for discrete variables. | `None`    |
...
| **kwargs            | dict                                                 | Passed as-is to `matplotlib.pyplot.hist()` or `matplotlib.pyplot.plot()` function depending on the value of `kind`.                                                                                                                           | `{}`      |
...
| data                   | pd.DataFrame or None            | An optional data frame with values for the predictors that are used to obtain out-of-sample predictions. If omitted, the original dataset is used.                                                                                                                                                                                                                                                                                                                    | `None`              |
...
| var_names    | str, list of str or None | A list of names of variables for which to compute the prior predictive distribution. Defaults to `None` which means both observed and unobserved RVs. | `None`    |
| omit_offsets | bool                     | Whether to omit offset terms in the plot. Defaults to `True`.                                                                                         | `True`    |
| random_seed  | int or None              | Seed for the random number generator.                                                                                                                 | `None`    |
...
| Name    | Type          | Description                                                                                                                                                | Default    |
|---------|---------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| idata   | InferenceData | The `InferenceData` instance returned by `.fit()`. It should contain the `posterior_predictive` group, otherwise it will be computed and added to `idata`. | _required_ |
| summary | bool          | If `True`, it returns a summary of the Bayesian R². Otherwise, it returns the posterior samples of the Bayesian R².                                        | `True`     |

#### Returns {.doc-section .doc-section-returns}

| Name   | Type          | Description                                                                                                            |
|--------|---------------|------------------------------------------------------------------------------------------------------------------------|
|        | pandas.Series | A series with the following indices: r2: mean value for the Bayesian R² r2_std: standard deviation of the Bayesian R². |
...
| Name    | Type               | Description                                                                          | Default    |
|---------|--------------------|--------------------------------------------------------------------------------------|------------|
| aliases | dict of str to str | A dictionary where key represents the original term name and the value is the alias. | _required_ |
...
| Name           | Type                        | Description                                                                                                                                                                  | Default   |
|----------------|-----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
| priors         | dict or None                | Dictionary of priors to update. Keys are names of terms to update; values are the new priors (either a `Prior` instance, or an int or float that scales the default priors). | `None`    |
| common         | (Prior, int, float or None) | A prior specification to apply to all common terms included in the model.                                                                                                    | `None`    |
| group_specific | (Prior, int, float or None) | A prior specification to apply to all group specific terms included in the model.                                                                                            | `None`    |