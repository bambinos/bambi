...
----------------------------
You can use any valid PyMC3 distribution as a prior. You can find a list of all the distributions available in PyMC3 [here](https://www.pymc.io/projects/docs/en/stable/api/distributions.html).  You can also find examples of how to specify priors in the [Bambi examples](https://bambinos.github.io/bambi/examples.html), and in the [Getting Started Guide](https://bambinos.github.io/bambi/notebooks/getting_started.html#Specifying-priors).
