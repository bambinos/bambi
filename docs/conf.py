# -*- coding: utf-8 -*-
#
# bambi documentation build configuration file, created by
# sphinx-quickstart on Sun Apr  2 15:22:20 2017.
#
...
author = u'The developers of Bambi'
...
latex_documents = [
    (master_doc, 'bambi.tex', u'bambi Documentation',
     u'bambi developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'bambi', u'bambi Documentation',
     [author], 1)
]
